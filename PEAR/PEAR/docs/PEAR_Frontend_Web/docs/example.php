...
if ($env=getenv('PHP_PEAR_INSTALL_DIR')) {
    ...
    putenv('PHP_PEAR_INSTALL_DIR=D:\wamp\www\supply\PEAR\PEAR');
}
/*
...
if ($env=getenv('PHP_PEAR_BIN_DIR')) {
    ...
    putenv('PHP_PEAR_BIN_DIR=D:\wamp\www\supply\PEAR');
}
/*
...
if ($env=getenv('PHP_PEAR_PHP_BIN')) {
    ...
    putenv('PHP_PEAR_PHP_BIN=D:\wamp\www\supply\PEAR\');
}
...
ini_set('include_path', 'D:\wamp\www\supply\PEAR\PEAR');
// Configfile
